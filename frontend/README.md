...
-📢 Announcements:
    ...
    Share updates, notices, or important alerts


- 💬 Queries Management:
      View user queries
      Respond to student doubts and issues


- 😊 Learner Satisfaction System:
...
- 🎓 Enrolled Courses (Learning System):
...
📌 Project Goal - To simulate a real-world EdTech LMS platform that includes:
